...
const features = [
  {
    ...
    description:
      "Use your WantShip's board to let users submit features they want.",
        ...
        <div className="w-full translate-x-12 bg-base-200 rounded-t-box h-full p-6">
          ...
          >
            ...
            <div className="opacity-0 group-hover:opacity-100 duration-500">
              I think adding multi-language support would really help, especially for users in non-English speaking countries.
            </div>
            <div className="opacity-0 group-hover:opacity-100 duration-1000 flex items-center gap-0.5">
              <span>It could broaden your user base.</span>
              <span className="w-[2px] h-6 bg-primary animate-pulse"></span>
            </div>
  ...
  },
  {
    ...
    demo: (
      <div className="px-6 max-w-[600px] flex flex-col gap-4 overflow-hidden">
        {[
          {
            text: "Provide analytics on user engagement trends",
            secondaryText: "This is a must-have! 📈",
            votes: 57,
            transition: "group-hover:-mt-36 group-hover:md:-mt-28 duration-500",
          },
          {
            text: "Create a mobile app version for on-the-go access",
            secondaryText: "YES! I need this for my phone! 📱",
            votes: 42,
          },
          {
            text: "Allow custom branding options for users",
            secondaryText: "This would make my life so much easier! 🎨",
            votes: 19,
          },
        ].map((feature, i) => (
          <div
  ...
  },
  {
    ...
    description: "Customize your WantShip board with 7 themes.",
    styles: "md:col-span-2 bg-base-200 text-base-content rounded-3xl flex flex-col gap-6 w-full h-[22rem] xl:h-[25rem] pt-6 overflow-hidden group",
    demo: (
...
const FeaturesGrid = () => {
  return (
    <section className="flex justify-center items-center w-full bg-[#00101c] text-base-content py-20 xl:py-32">
      <div className="flex flex-col max-w-[82rem] gap-16 md:gap-20 px-4">
        <h2 className="max-w-3xl font-extrabold text-4xl md:text-6xl tracking-[-0.01em]">
